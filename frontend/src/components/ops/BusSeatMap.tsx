...
//
// ПРИМІТКА: презентаційний компонент. Місце туриста в автобусі вже
// зберігається (BookingTourist.busSeaNumber, OPS-03), і є GET
// /bookings/:id/seat-map (реалізовано), але той ендпоінт зав'язаний
// на конкретний booking, а не на тур в цілому — немає природної точки
// входу з картки туру (TourDetail). Компонент готовий до підключення,
// коли з'явиться tour-scoped ендпоінт або UI знатиме, який booking
// показати.
// ============================================================
